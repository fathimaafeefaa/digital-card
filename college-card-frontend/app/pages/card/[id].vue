<template>
  <div class="flex justify-center">
    ...
    <div v-else-if="student" class="w-full max-w-sm">
      <!-- Digital Card -->
      <div class="overflow-hidden shadow-2xl bg-eau-navy rounded-2xl">
        <!-- Top Banner -->
        <div class="flex items-center justify-between px-6 py-3 bg-eau-gold">
          <span class="text-sm font-bold text-eau-navy">EMIRATES AVIATION UNIVERSITY</span>
          <span class="text-xs font-semibold text-eau-navy">STUDENT ID CARD</span>
        </div>
        ...
        <div class="px-6 py-6">
          ...
          <div class="flex justify-center mb-4">
            <div
              class="flex items-center justify-center overflow-hidden bg-gray-200 border-4 rounded-full w-28 h-28 border-eau-gold">
              <img v-if="student.photo_url" :src="student.photo_url" class="object-cover w-full h-full" />
              <span v-else class="text-5xl font-bold text-gray-400">
          ...
          <div class="mb-6 text-center">
            ...
            <p class="text-eau-gold text-sm font-semibold mt-0.5">{{ student.Department?.name }}</p>
          </div>
          ...
          <div class="mb-6 space-y-2">
            ...
            <div class="flex justify-between">
              <span class="text-xs text-gray-400">Year of Study</span>
            ...
            <div class="flex justify-between">
              ...
              <span class="text-xs font-semibold text-white">{{ student.phone || 'N/A' }}</span>
            </div>
            <div class="flex justify-between">
        ...
        <!-- Footer -->
        <div class="px-6 py-2 text-center bg-eau-gold">
          <span class="text-xs font-semibold text-eau-navy">
      ...
      <button @click="downloadCard"
        class="w-full mt-4 bg-eau-gold text-eau-navy font-semibold py-2.5 rounded-lg hover:opacity-90 transition">
        Download Card
      </button>
    </div>
